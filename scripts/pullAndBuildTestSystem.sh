...
if [ ! -e minorGems ]
then
	git clone https://github.com/mattingale/minorGems.git	
fi

if [ ! -e OneLife ]
then
	git clone https://github.com/mattingale/OneLife.git
fi

if [ ! -e OneLifeData7 ]
then
	git clone https://github.com/mattingale/OneLifeData7.git	
fi
